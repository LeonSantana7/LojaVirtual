<?php 
	...
	$camisas = array(
		['name' => 'camisa 01', 'image' => 'uploads/img1.jpg', 'price' => '55.9'],
		['name' => 'camisa 02', 'image' => 'uploads/img2.jpg', 'price' => '45.9'],
		['name' => 'camisa 03', 'image' => 'uploads/img3.jpg', 'price' => '65']
	);
?>
<!DOCTYPE html>
<html lang="pt-br">
	...
	<nav class="navbar navbar-light bg-danger">
	  <div class="container">
	    <a class="navbar-brand" href="#">
	      <img src="images/Store.png" alt="" width="50" height="50" class="d-inline-block align-text-top">
	    </a>
	  </div>
	</nav>
